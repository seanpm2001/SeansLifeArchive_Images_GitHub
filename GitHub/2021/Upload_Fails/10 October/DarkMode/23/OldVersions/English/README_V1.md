...
- [ ] 500 Server error <!-- 2021 October 19th !-->
...
- [x] Unicorn! or `this page is taking too long to load` (4 times today, a lot better than yesterday, but still bad. It was so much better today, but unfortunately, this was only temporary) <!-- my account has too many variables to calculate when constantly refreshing, although this is the first time it has done it on my profile page. !-->
