...
- [x] Unicorn! or `this page is taking too long to load` (8 times today, a lot better than yesterday, but still not good.) <!-- my account has too many variables to calculate when constantly refreshing, although this is the first time it has done it on my profile page. !-->
