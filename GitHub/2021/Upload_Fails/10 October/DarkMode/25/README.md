...
- [x] 500 Server error (2x today) <!-- 2021 October 25th !-->
...
- [x] Unicorn! or `this page is taking too long to load` (62 times today, setting a record for the worst amount of errors I have received in 1 day) <!-- my account has too many variables to calculate when constantly refreshing, although this is the first time it has done it on my profile page. !-->
