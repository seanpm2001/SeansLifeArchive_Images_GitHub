...
- [ ] 500 Server error <!-- 2021 October 25th !-->
...
- [x] Unicorn! or `this page is taking too long to load` (9 times today, a bit worse than yesterday, but still bad. It was still not the worst today, but unfortunately, this was only temporary, it got MUCH worse the next day) <!-- my account has too many variables to calculate when constantly refreshing, although this is the first time it has done it on my profile page. !-->
