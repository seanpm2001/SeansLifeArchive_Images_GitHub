...
ERROR COUNT (2021 November 16th) 97
...
- [x] Unicorn! or `this page is taking too long to load` (84 times today, exponentially worse than yesterday, but still not good.) <!-- my account has too many variables to calculate when constantly refreshing, although this is the first time it has done it on my profile page. !-->

- [ ] This Wiki page took too long to render

- [ ] GitHub claims that a repository doesn't exist (temporary)

- [x] Upload fail: instant white page upon publish, requires re-upload (13x today)

- [ ] Upload fail: upload got stuck on last 1-2 files, had to restart the process (0x today)

<!-- [x] 404 - 404 on brand new file (2021 November 18th, 1x) !-->
