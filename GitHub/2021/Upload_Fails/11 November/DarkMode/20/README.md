...
ERROR COUNT (2021 November 20th) 32
...
- [ ] Commit failed due to an unknown error <!-- (2021 November 21st) !-->
...
- [x] Unicorn! or `this page is taking too long to load` (28 times today, exponentially worse than yesterday, but still not good.) <!-- my account has too many variables to calculate when constantly refreshing, although this is the first time it has done it on my profile page. !-->

- [ ] This Wiki page took too long to render

- [ ] GitHub claims that a repository doesn't exist (temporary)

- [x] Upload fail: instant white page upon publish, requires re-upload (3x today)

- [ ] Upload fail: upload got stuck on last 1-2 files, had to restart the process (0x today)

<!-- - [x] Secondary Rate Limit error (using GitHub while not logged in) (1x today) !-->

- [x] 404 - 404 on brand new file/fork (1x today)
