...
ERROR COUNT (2021 November 27th) 29
...
- [X] Failed to create repository, 404 page (2x today)

- [ ] "something went really wrong and we can't process that file"

- [ ] Server failed to fetch content, or "we had issues processing your request"

- [X] Unicorn! or `this page is taking too long to load` (HTTP 504) (19 times today, significantly better than yesterday, but still not good.) <!-- my account has too many variables to calculate when constantly refreshing, although this is the first time it has done it on my profile page. !-->

- [ ] This Wiki page took too long to render

- [ ] GitHub claims that a repository doesn't exist (temporary)

- [x] Upload fail: instant white page upon publish/reload (7x today)
...
- [x] Forced logout, had to sign back in
