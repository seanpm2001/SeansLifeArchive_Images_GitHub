...
- [x] Unicorn! or `this page is taking too long to load` (38 times today, a lot worse than yesterday, but still not good.) <!-- my account has too many variables to calculate when constantly refreshing, although this is the first time it has done it on my profile page. !-->

- [ ] This Wiki page took too long to render

- [ ] GitHub claims that a repository doesn't exist (temporary)

- [x] Upload fail: instant white page upon publish, requires re-upload (7x today)

- [x] Upload fail: upload got stuck on last 1-2 files, had to restart the process (1x today)
