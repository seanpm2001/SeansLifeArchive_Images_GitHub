...
- [ ] Unicorn! or `this page is taking too long to load`

- [ ] This Wiki page took too long to render

- [x] GitHub activity calendar rendered incorrectly

- [x] Repository failed to generate from template (it later corrected itself)
